...
//            $codeVerifier = bin2hex(random_bytes(64)); //old method
            $codeVerifier = $this->base64url_encode(pack(
                'H*',
...
//                $codeChallenge = rtrim(strtr(base64_encode(hash($this->pkceAlgs[$codeChallengeMethod], $codeVerifier, true)), '+/', '-_'), '=');
                $codeChallenge = $this->base64url_encode(pack('H*',hash($this->pkceAlgs[$codeChallengeMethod], $codeVerifier)));
            } else {
